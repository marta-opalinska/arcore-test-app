...
public class Texture implements Closeable {
   ...
   */
  public Texture(MainRender render, Target target, WrapMode wrapMode) {
    this(render, target, wrapMode, /*useMipmaps=*/ true);
  }

  public Texture(MainRender render, Target target, WrapMode wrapMode, boolean useMipmaps) {
    this.target = target;
  ...
  public static Texture createFromAsset(
          MainRender render, String assetFileName, WrapMode wrapMode, ColorFormat colorFormat)
      throws IOException {
